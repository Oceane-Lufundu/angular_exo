...
public static main():void{
    ...
    //afficher liste des stagiaires avec leurs notes et moyennes
    console.log("\n: LISTE DES STAGIAIRES");
    console.log("=".repeat(50));
    formation.Stagiaire.forEach((_Stagiaires, index) => {
        console.log(`${index + 1}. ${_Stagiaires.nom}`);
        console.log(`   Notes: ${_Stagiaires.notes.join(", ")}`);
        console.log(`   Moyenne: ${_Stagiaires.calculerMoyenne().toFixed(2)}`);
        console.log(`   Note Max: ${_Stagiaires.trouverMax()}`);
        console.log(`   Note Min: ${_Stagiaires.trouverMin()}`);
